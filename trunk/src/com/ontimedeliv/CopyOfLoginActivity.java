...
public class CopyOfLoginActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (isChecked) {
			...
			Intent i = new Intent(this, CopyOfNavigationActivity.class);
	...
	public  void getLoggedIn(String s, String error) {
		if (error == null) {
			...
			Intent i;
			if (user.isIs_admin())
				i = new Intent(this, CopyOfNavigationActivity.class);
			else
	...
	public void forgotpassword(View view) {
		Intent i = new Intent(CopyOfLoginActivity.this, ForgotPasswordActivity.class);
		startActivity(i);
	}
				...
				.setPositiveButton("Yes",
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
									int which) {
								CopyOfLoginActivity.this.finishAffinity();
							}
